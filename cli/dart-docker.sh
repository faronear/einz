...
#   ./cli/dart-docker.sh build      # 容器内编译 Linux TUI 产物 → _release.gitomit/einz-tui-linux-<架构>-<yymmddhhmm>
#
# 说明：
...
setup() {
  ...
  echo "   编 Linux 产物：$0 build   （产物在 _release.gitomit/einz-tui-linux-<架构>-<yymmddhhmm>）"
